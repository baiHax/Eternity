...
exports.commands = {
	...
	away: function (target, room, user, connection, cmd) {
		...
		if (statusLen > 5) return this.sendReply("Your away status should be short and to-the-point, not a dissertation on why you are away.");
	...
	**************************/
	...
	ship: function (target, room, user) {
		if (!this.canTalk()) return;
		if (!this.runBroadcast()) return;
		if (room== "lobby") return this.errorReply(`Nope.`);
