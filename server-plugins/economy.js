...
global.moneyName = 'Eternity Dollar';
global.moneyPlural = 'Eternity Dollars';

let shop = [
	['Avatar', 'Compra un avatar para lucirlo en tu perfil(Debe ser 80x80).', 60],
	['Custom Color', 'Cambia el color de tu nombre/nick(Puede ser denegado).', 45],
	['Icon', 'Compra una imagen que se vera en tu PM box.', 25],
	['Room', 'Compra una sala en la que seras Room Owner, allí podrás hacer todo lo que quieras mientras no incumpla las reglas del servidor.', 100],
	['Symbol', 'Compra un simbolo para aparecer arriba de la lista de usuarios.', 25],
];
...
function getShopDisplay(shop) {
	let display = "<center><img src='https://i.imgur.com/3Zma0H5.png'><br><div' + (!this.isOfficial ? ' class=infobox-limited' : '') + '><table style='background: #000000; border-color: #027947; border-radius: 8px' border='1' cellspacing='0' cellpadding='5' width='100%'>" +
		"<tbody><tr><th><font color=#027947 face=courier>Item</font></th><th><font color=#027947 face=courier>Description</font></th><th><font color=#027947 face=courier>Price</font></th></tr>";
	let start = 0;
	while (start < shop.length) {
		display += "<tr>" +
			"<td align='center'><button name='send' style='background: #000000; border-radius: 5px; border: solid, 1px, #027947; font-size: 11px; padding: 5px 10px' value='/buy " + shop[start][0] + "'><font color=#027947 face=courier><b>" + shop[start][0] + "</b></font></button>" + "</td>" +
			"<td align='center'><font color=#027947 face=courier>" + shop[start][1] + "</font></td>" +
			"<td align='center'><font color=#027947 face=courier>" + shop[start][2] + "</font></td>" +
			"</tr>";
		start++;
	}
	display += "</tbody></table></div><br><center><font color=#000000 face=courier>To buy an item from the shop, use /buy <em>Item</em>.</font></center>";
	return display;
}
